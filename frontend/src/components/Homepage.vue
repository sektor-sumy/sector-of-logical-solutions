<template>
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" v-bind:class="{ 'navbar-shrink': bodyScroll }"
             id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" v-scroll-to="'#page-top'">Start Bootstrap</a>
                <button @click="actionMenu" class="navbar-toggler navbar-toggler-right" type="button"
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li
                                ...
                                class="nav-item"
                        >
                            <a class="nav-link js-scroll-trigger" v-scroll-to="{ element: '#'+item.slug }">{{
                                item.contentLang[locale].title }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<style>
    @import '../../../vendor-web/font-awesome/css/font-awesome.min.css';
